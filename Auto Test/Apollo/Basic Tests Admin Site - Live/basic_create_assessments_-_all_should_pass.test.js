...
"@page https://apolloadministration.adc.uk.com";
...
"@test"["Basic Admin Dilemmas"] = {
    ...
    '2.Type in password input "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtPassword$/)", "Black72house");
    },
...
"@test"["Call Centre Dilemmas"] = {
    ...
    '7.Type in input "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectName$/)", "Call Centre Dilemmas");
    },
    '9.Type in text area "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectDesc$/)", "Created using auto software");
    },
    ...
    '11.Click option "Administrative..."': function() {
        var actionTarget = function() {
            return $(":containsExcludeChildren(Call Centre Dilemmas)").eq(0);
        };
        act.click(actionTarget);
    },
    '12.Click select "ctl00$ContentPlaceH..."': function() {
...
"@test"["Customer Service Dilemmas"] = {
    ...
    '7.Type in input "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectName$/)", "Customer Service Dilemmas");
    },
    '9.Type in text area "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectDesc$/)", "Created using auto software");
    },
    ...
    '11.Click option "Administrative..."': function() {
        var actionTarget = function() {
            return $(":containsExcludeChildren(Customer Service Dilemmas)").eq(0);
        };
        act.click(actionTarget);
    },
    '12.Click select "ctl00$ContentPlaceH..."': function() {
    ...
    '20.Click option "Norm 1 -..."': function() {
        act.click(":containsExcludeChildren(Norm 1 Customer Service Staff)");
    },
    '21.Click button "Next"': function() {
        act.click(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_btnNext$/)");
    },
...
"@test"["Fire Rescue Service SJT"] = {
    ...
    '17.Click option "UK Firefighters"': function() {
        act.click(":containsExcludeChildren(UK Firefighters)");
    },
    '18.Click select "ctl00$ContentPlaceH..."': function() {
        act.click(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_ddlScoreScale$/)");
    },
...
"@test"["Graduate Dilemmas A"] = {
    ...
    '6.Type in input "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectName$/)", "Graduate Dilemmas A");
    },
...
"@test"["Management Dilemmas"] = {
    ...
    '6.Type in input "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectName$/)", "Management Dilemmas");
    },
    '7.Type in text area "ctl00$ContentPlaceH..."': function() {
        act.type(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_txtProjectDesc$/)", "Created using auto software");
    },
    ...
    '10.Click option "Management Dilemmas"': function() {
        var actionTarget = function() {
            return $(":containsExcludeChildren(Management Dilemmas)").eq(0);
        };
        act.click(actionTarget);
    },
    '11.Click select "ctl00$ContentPlaceH..."': function() {
    ...
    '19.Click option "Norm 1 –..."': function() {
        act.click(":containsExcludeChildren(Norm 1 Managers All Levels)");
    },
    '20.Click button "Next"': function() {
        act.click(":attrRegExp(id:/^ctl\\d+_ContentPlaceHolder1_btnNext$/)");
    },
